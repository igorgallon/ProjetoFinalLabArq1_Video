...
add wave -group decode -radix hexadecimal sim:/t_processor/the_processor/jump_control
...
add wave -group alu -radix hexadecimal sim:/t_processor/the_processor/alu_result
